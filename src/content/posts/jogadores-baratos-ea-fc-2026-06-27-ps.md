...
title: "Laterais baratos no EA FC em 27/06 — PS"
draft: false
featured: false
tags:
  - baratos
  ...
  - budget
  - ps
description: "Em 27/06/2026 no PS, Bixente Lizarazu liderou a seleção de Laterais por 13.000 coins. Compare 15 cartas, OVR, preço, 7d e gráfico."
---
...
Entre 15 opções, **Sonia Bompastor** tinha o menor preço (12.000 coins). O maior OVR era de **Bixente Lizarazu** (93), por 13.000 coins.

O preço mediano do recorte foi **14.000 coins** e 10 cartas vinham de queda em 7d. 2 opções estavam exatamente no teto de 15.000 coins. OVR é só um filtro inicial; função, atributos, PlayStyles e química precisam ser conferidos antes de montar o time.

![Gráfico de preço em coins para os destaques de Laterais baratos no EA FC em 27/06 — PS](/charts/jogadores-baratos-ea-fc-2026-06-27-ps.svg)

*Gráfico gerado exclusivamente com os valores da tabela deste artigo.*
<!-- /historical-review:v1 -->

Dá para montar um time forte no **EA FC Ultimate Team** sem torrar coins. O **FutQuant** filtrou as **cartas 83+ que custam até 15 mil coins** em **27/06/2026** no **Console (PS)** — puro custo-benefício, sem anomalias de preço.
...
- **Amar Dedić (93, RB)**, sem liga informada, a apenas **14k coins**

- **Jason Geria (93, RB)**, sem liga informada, a apenas **14k coins**

- **Amir Murillo (92, RB)**, sem liga informada, a apenas **14k coins**

- **Yan Valery (91, RB)**, sem liga informada, a apenas **15k coins** — já **valorizando**, o que indicava procura crescente naquele recorte.
