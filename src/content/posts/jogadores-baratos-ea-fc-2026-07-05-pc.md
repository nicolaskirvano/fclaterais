...
pubDatetime: 2026-07-05T19:11:09.000Z
title: "Laterais baratos no EA FC em 05/07 — PC"
draft: false
featured: false
tags:
  - baratos
  ...
  - budget
  - pc
description: "Em 05/07/2026 no PC, Jason Geria liderou a seleção de Laterais por 14.000 coins. Compare 7 cartas, OVR, preço, 7d e gráfico."
---

<!-- historical-review:v1 -->
> **Arquivo histórico — 05/07/2026, PC:** os preços e previsões deste artigo preservam o snapshot original e não representam a cotação atual.

## Leitura do recorte

Entre 7 opções, **Nuno Mendes** tinha o menor preço (2.000 coins). O maior OVR era de **Jason Geria** (93), por 14.000 coins.

O preço mediano do recorte foi **14.000 coins** e 1 cartas vinham de queda em 7d. Todas estavam estritamente abaixo de 15.000 coins. OVR é só um filtro inicial; função, atributos, PlayStyles e química precisam ser conferidos antes de montar o time.

![Gráfico de preço em coins para os destaques de Laterais baratos no EA FC em 05/07 — PC](/charts/jogadores-baratos-ea-fc-2026-07-05-pc.svg)
...
| Sonia Bompastor | 86 | LB | D1 Arkema | 11k coins | +4.7% |
...
- **Jason Geria (93, RB)**, sem liga informada, a apenas **14k coins**

- **Bixente Lizarazu (88, LB)** da Bundesliga, a apenas **14k coins** — vem **caindo na semana**, era uma opção relativamente barata naquele recorte.

- **David Raum (87, LB)** da Bundesliga, a apenas **14k coins**

- **Nuno Mendes (86, LB)** da Ligue 1 McDonald's, a apenas **2k coins** — já **valorizando**, o que indicava procura crescente naquele recorte.
...
**Qual era o destaque barato do EA FC em 05/07/2026?**
Jason Geria (93, sem liga) aparece como melhor custo-benefício, a 14k coins no PC.
...
*Preços de PC, referência de 05/07/2026. Variações de mercado mudam a qualquer momento — invista com responsabilidade.*
