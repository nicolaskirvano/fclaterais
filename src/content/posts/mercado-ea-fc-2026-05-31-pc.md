...
title: "Laterais no EA FC em 31/05: altas e baixas — PC"
draft: false
featured: true
tags:
  - mercado
  ...
  - altas-e-baixas
  - pc
description: "Snapshot histórico de 31/05/2026 no PC: Álvaro Carreras liderou as altas e Konrad Laimer as baixas em Laterais. Compare preços, variações, gráfico e riscos."
---
...
Nas 20 cartas destacadas nas tabelas, **Álvaro Carreras** registrou o maior movimento de 24h (+59,4%), enquanto **Konrad Laimer** marcou o menor (-45,4%). A distância entre os extremos foi de **104,8 pontos percentuais**.

A mediana de 24h do recorte ficou em **+4,8%**: 10 destaques subiam e 10 caíam. Essa dispersão ajuda a comparar o dia, mas não transforma o snapshot antigo em preço ou sinal atual.

![Gráfico de variação em 24h para os destaques de Laterais no EA FC em 31/05: altas e baixas — PC](/charts/mercado-ea-fc-2026-05-31-pc.svg)
...
- **Timothy Weah (85)** subiu **+54.6%** em 24h, a **42k coins** (faixa do dia: 27k–47k). Está +58% acima da média de 7 dias (aquecida). Naquele snapshot, o modelo indicava **estabilização** no curto prazo.

- **Fridolina Rolfö (90)** subiu **+53.7%** em 24h, a **103k coins** (faixa do dia: 53k–120k). Está +37% acima da média de 7 dias (aquecida). Naquele snapshot, o modelo indicava **estabilização** no curto prazo.
...
- **Katie McCabe (88)** caiu **-38.1%** em 24h, a **25k coins** (faixa do dia: 12k–40k). Está em linha com a média de 7 dias (+8%). Naquele snapshot, o modelo indicava **estabilização** no curto prazo.

- **Archie Brown (85)** caiu **-36.5%** em 24h, a **82k coins** (faixa do dia: 72k–150k). Está em linha com a média de 7 dias (-3%). Naquele snapshot, o modelo indicava **estabilização** no curto prazo.
...
Naquele dia, o mercado estava em alta — predominam as valorizações, com 82 cartas em alta contra 96 em queda (média 1.57%).
...
- [Momentum de Laterais no EA FC em 31/05 — PC](/posts/melhores-investimentos-ea-fc-2026-05-31-pc/)
