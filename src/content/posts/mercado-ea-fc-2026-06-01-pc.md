...
title: "Laterais no EA FC em 01/06: altas e baixas — PC"
draft: false
featured: true
tags:
  - mercado
  ...
  - altas-e-baixas
  - pc
description: "Snapshot histórico de 01/06/2026 no PC: Denzel Dumfries liderou as altas e Katie McCabe as baixas em Laterais. Compare preços, variações, gráfico e riscos."
---
...
Nas 20 cartas destacadas nas tabelas, **Denzel Dumfries** registrou o maior movimento de 24h (+58,8%), enquanto **Katie McCabe** marcou o menor (-47,6%). A distância entre os extremos foi de **106,4 pontos percentuais**.
...
![Gráfico de variação em 24h para os destaques de Laterais no EA FC em 01/06: altas e baixas — PC](/charts/mercado-ea-fc-2026-06-01-pc.svg)
...
- **Denzel Dumfries (86)** subiu **+58.8%** em 24h, a **34k coins** (faixa do dia: 21k–70k). Está +32% acima da média de 7 dias (aquecida). Naquele snapshot, o modelo indicava **estabilização** no curto prazo.

- **Ashley Cole (88)** subiu **+53.3%** em 24h, a **23k coins** (faixa do dia: 11k–32k). Está +24% acima da média de 7 dias (aquecida). Naquele snapshot, o modelo indicava **estabilização** no curto prazo.
...
- **Katie McCabe (89)** caiu **-47.6%** em 24h, a **24k coins** (faixa do dia: 24k–48k). Está -24% abaixo da média de 7 dias (descontada). 🔮 Naquele snapshot, o modelo projetava **recuperação** (reversão para alta), com 73% de probabilidade.

- **Alfonso Espino (86)** caiu **-33.9%** em 24h, a **20k coins** (faixa do dia: 19k–30k). Está -30% abaixo da média de 7 dias (descontada). Naquele snapshot, o modelo indicava **estabilização** no curto prazo.

- **Katie McCabe (92)** caiu **-32.4%** em 24h, a **24k coins** (faixa do dia: 22k–38k). Está em linha com a média de 7 dias (-8%). Naquele snapshot, o modelo indicava **estabilização** no curto prazo.
...
Naquele dia, o mercado estava em alta — predominam as valorizações, com 69 cartas em alta contra 114 em queda (média 1.93%).
...
- [Laterais baratos no EA FC em 01/06 — PC](/posts/jogadores-baratos-ea-fc-2026-06-01-pc/)
- [Momentum de Laterais no EA FC em 01/06 — PC](/posts/melhores-investimentos-ea-fc-2026-06-01-pc/)
